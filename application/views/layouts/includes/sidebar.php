<div class="cart-block">
    <form action="cart/update" method="post">
        <table cellpading="6" cellspacing="1" style="width:100%" border="0">
            <tr>
                <th>QTY</th>
                <th>Item Description</th>
                <th style="test-align:right">item Price</th>
            </tr>
           ...
           <?php $i= 1; ?>
            ...
            <input type="hidden" name="<?php echo $i.'[rowid]';?>" value="<?php echo $items['rowid']; ?>" />
                   <tr>
                       ...
                       <td style="text-allign:right">&#8358;<?php echo $this->cart->format_number($items['price']); ?></td>
                   </tr>
            <?php $i++; ?>
            <?php endforeach; ?>
            <tr>
