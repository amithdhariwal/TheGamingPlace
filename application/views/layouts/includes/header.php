...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            ...
            <?php else: ?>
                <form class="navbar-from navbar-right" method="post" action="<?php echo base_url();?>users/logout">
                    <button name="submit" class="btn btn-default" type="submit" >Logout</button>
                </form>
